''' Question 3
The City class has the following attributes: name, country (where the city is located), elevation (measured in meters), and population (approximate, 
according to recent statistics). Fill in the blanks of the max_elevation_city function to return the name of the city and its country (separated by a comma), 
...
def max_elevation_city(min_population):
	...
	if	city2.population >= min_population:
		if city2.elevation > return_city.elevation:
			return_city = city2
